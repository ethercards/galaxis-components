...
var GalaxisCard = function GalaxisCard(_ref) {
  ...
  var getVisibilityWithData = function getVisibilityWithData(item) {
    ...
    if (BigNumber.from(item.data.expiration).toNumber() === 0) return true;
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading && /*#__PURE__*/React.createElement(SpinnerCircular, {
    ...
    return elem.icon_url ? /*#__PURE__*/React.createElement(React.Fragment, null, getVisibilityByProperty(elem) && /*#__PURE__*/React.createElement("div", {
